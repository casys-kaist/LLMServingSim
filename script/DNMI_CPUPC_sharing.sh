# Multiple(2) Instance in 2 Node , with NPU+CPU prefix caching, enabled Prefix sharing
...
#     --dataset '/dataset/example_trace.jsonl' --output 'output/memory_testing/example_dual_node_multi_instance_run_with_cpu_prefix_caching_sharing.csv' \
...
python main.py --cluster-config 'cluster_config/memory_testing/dual_node_multi_instance_with_cxl_A6000.json' \
    ...
    --enable-prefix-caching --prefix-storage "CPU" --enable-prefix-sharing \
    --dataset '/dataset/example_trace.jsonl' --output 'output/memory_testing/example_dual_node_multi_instance_run_with_cpu_prefix_caching_sharing_A6000.csv' \
